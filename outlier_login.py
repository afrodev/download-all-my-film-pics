...
class User:
    ...
    # Immediately i'm seeing that it went for failed attempts only even tho it was never specified
    # I think it should it be login attempts in total
...
class AuthenticationSystem:
    ...
    def login(self, username, password):
        ...
        # I don't think this actually chekcs against saved password.
        # It also adds fail if password is correct
    ...
    # updates fails and lock status correctly on paper...
    # Except it equates attempts left with attempts so far
